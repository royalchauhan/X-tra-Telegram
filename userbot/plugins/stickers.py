...
async def _(event):
    ...
    packname = f"@royal2468's kang pack  {userid}"
    packshortname = f"Kang_pack_by_royal_{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"@royal2468's animated pack "
        if userid == 602507578:
            packshortname = "Royal_Animated_pack"
        else:
